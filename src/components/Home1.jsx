 ...
 <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center ">
        ...
        <div className="flex flex-row items-center justify-center space-x-4 flex-wrap">
          <img
            src={Z1}
            alt="Left Decoration"
            className=" relative w-16 sm:w-32 md:w-40 lg:w-48 xl:w-100 h-auto"
          />
          <h1 className="text-[#e9d2b4] font-serif text-xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-tight ">
            KINGS
            <br />
            <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl">AND</span>
            <br />
            <span className=''>
            QUEENS</span>
          </h1>
          ...
          <img
            ...
            className="w-10 sm:w-32 md:w-40 lg:w-48 xl:w-auto h-auto"
          />
        </div>
        <p className="mt-6  text- sm:text-base md:text-lg font-medium max-w-2xl text-gray-300">
 ...
 <div className='flex justify-center items-center '>
  ...
  <p className="text-sm text-gray-800 max-w-xs text-center mt-2">Full contact combat displays, archery demonstrations, dance displays and our medieval encampment</p>
    ...
    <div className=' mt-10 flex justify-center'>
         <div className='border h-10 w-50 text-center p-2 font-bold bg-yellow-600 border-yellow-800 hover:bg-black text-white rounded-full'>Show  All  Events</div>
         </div>
  </div>
    ...
    >
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12 items-start">
        <div>
          ...
          <h2 className="text-5xl md:text-6xl font-bold italic text-black leading-tight mb-8">
